        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-8 space-y-10 order-2 lg:order-1">
            ...
            {filteredBlogs.length === 0 ? (
              <div className="text-center py-24 bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-100 shadow-sm flex flex-col items-center justify-center space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {filteredBlogs.map((blog) => (
                  <article
                    key={blog._id}
                    className="bg-white/90 backdrop-blur-sm rounded-3xl overflow-hidden border border-white/40 shadow-sm hover:shadow-md transition-shadow flex flex-col h-full group"
                  >
          ...
          <div className={`lg:col-span-4 space-y-12 lg:pl-4 order-1 lg:order-2 ${searchQuery.trim() !== "" ? "hidden lg:block" : ""}`}>
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-full text-xs font-semibold transition-all border
                      ${selectedCategory === cat
                        ...
                        : "bg-white/80 text-slate-600 border-white/60 hover:border-slate-300 hover:bg-slate-50 shadow-sm"
                      }
                    `}
                  >
                    {cat}
            ...
            {/* Recent Posts */}
            <div className="space-y-5 pt-8 border-t border-slate-200/60">
