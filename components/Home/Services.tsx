...
export default function Services({ cms }: ServicesProps) {
  const t = (val: string) => getCmsVal(cms, val, "services");
  ...
  const services = [
    {
      ...
      slug: "ac-work",
      icon: "ac_unit",
      image: String(t("https://lh3.googleusercontent.com/aida-public/AB6AXuCLiQsbcp9CIvalj5HlgjAve6IxUGPSM4J-rGQq130UOkUMQG3RJJCQ2VxXErbDVyZwlWwoozwli_5Mv_hiHzR9zCo-40P8adNutOjMh5UhTfpRgW6pQ4W_MPc5Oz_F5Q6dBk4Vx6FHUikwhJpMBY0uG8hPWprKrjWOPxqsmVNqoIkbd9076ARuMQDzyUF4uTjIqE1SdWHtss1QEihvuapg3LfDvz_4hZPH2R2gu1DvRx1xbdRqnmlIckfa_SmVFDLyVLHVKqK7qm8"))
    },
    {
      title: t("Plumbing"),
      description: t("From AED 99"),
      slug: "plumbing-work",
      icon: "plumbing",
      image: String(t("https://lh3.googleusercontent.com/aida-public/AB6AXuCelodmM1FwEyBLvvhwDxzmyF0fjretE3ZQEgmJJXMAdjPt014WY6Q8ywRyMelt9kaxzIbiLWsxzDMOWu7lOXUKBk4lml5zPmiUWxCz4No6C1Aqw-PsOOO77IXgDOHYTGBNmzBrPLJZXZ0nthZSBAZJrvSY9KgyiS76qNShEwYwI2bzWSv-XJtVq3S5LRyPRhGqS5J5uB60OKFrii9Mj3P1PoTKCMoObud-YcYw7jx968ppGjstF6V57LDLPPyK_NAY9kk3GA7YMFc"))
    },
    {
      title: t("Electrical"),
      ...
      icon: "bolt",
      image: String(t("https://lh3.googleusercontent.com/aida-public/AB6AXuDSlvPWqj6GwG_HDpZ-1FpLBOTxqrXSg0ZrxjGIQ_xrI5U5t-_F2xypsIE1pRIwElOsKFbtznu6nIyKpoyatolCBH647dyin6c276A2dhCmAYv9XcT3CuskjEdebghFo3C13iAVcad96KasFxwX-zzCTtoSNihcOsieoz4oRyDuTYvhwa6WdSLucXYjM9KfKOQfmv5djkHwa-3rogyX-T-daUFO_xpHrDFuWYzKZBDujfmmWcXjxfQBsArChDtwzpdGtuDkx0gHRIQ"))
    },
    {
      title: t("Cleaning"),
    ...
    },
    {
      ...
      icon: "chair",
      image: String(t("https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=500&q=80"))
    },
    {
      title: t("Handyman"),
      description: t("From AED 69"),
