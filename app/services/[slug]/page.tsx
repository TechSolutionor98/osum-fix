    ...
    return (
      <>
        ...
        <main className="bg-white">
          ...
          <section id="services" className="py-24 bg-gradient-to-b from-[#cdeae8] to-[#e2f2f1] relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:pr-8 lg:pl-28">
              <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <div className="space-y-16 lg:space-y-24">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">01</div>
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  ...
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">02</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Electrical Installations")}</h3>
                    </div>
                    <ul className="space-y-4">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">03</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Electrical Maintenance")}</h3>
                    </div>
                    <ul className="space-y-4">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 order-2 lg:order-1 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/electrical_additional.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Additional Services")} />
                  </div>
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">04</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Additional Services")}</h3>
                    </div>
                    <ul className="space-y-4">
          ...
          <section id="specialties" className="py-24 bg-gradient-to-b from-[#e2f2f1] to-[#fefaef] relative overflow-hidden">
          ...
          <section id="process" className="py-20 bg-gradient-to-b from-[#fefaef] to-[#e2f2f1]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:pr-8 lg:pl-28">
              <div className="text-center max-w-3xl mx-auto mb-16">
                <span className="text-[var(--primary)] font-semibold tracking-wider uppercase text-sm mb-2 block">{t("Our Workflow")}</span>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-5 xl:col-span-4">
                  <div className="relative aspect-[4/5] rounded-3xl overflow-hidden group">
                    <Image src={t("/images/services/electrical_workflow.png")} fill sizes="(max-width: 1024px) 100vw, 33vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Service Workflow")} />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-16 lg:space-y-24">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">01</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Plumbing Repairs")}</h3>
                    </div>
                    <ul className="space-y-4">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  ...
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">02</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Drainage Services")}</h3>
                    </div>
                    <ul className="space-y-4">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">03</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Water Heater Services")}</h3>
                    </div>
                    <ul className="space-y-4">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  ...
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">04</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Plumbing Installs")}</h3>
                    </div>
                    <ul className="space-y-4">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">05</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Preventive Care")}</h3>
                    </div>
                    <ul className="space-y-4">
              ...
              <div className="space-y-16 lg:space-y-24">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">01</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Interior Painting")}</h3>
                    </div>
                    <ul className="space-y-4">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  ...
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">02</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Exterior Painting")}</h3>
                    </div>
                    <ul className="space-y-4">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">03</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Residential Painting")}</h3>
                    </div>
                    <ul className="space-y-4">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  ...
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">04</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Commercial Painting")}</h3>
                    </div>
                    <ul className="space-y-4">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">05</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Decorative Finishes")}</h3>
                    </div>
                    <ul className="space-y-4">
    ...
    return (
      <>
        ...
        <main className="bg-white">
          ...
          {/* Section 3: Our Masonry & Civil Services (Premium Alternating Layout) */}
          <section id="services" className="py-24 bg-gradient-to-b from-[#cdeae8] to-[#e2f2f1] relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:pr-8 lg:pl-28">
              <div className="text-center max-w-3xl mx-auto mb-16">
                <span className="text-[var(--primary)] font-semibold tracking-wider uppercase text-sm mb-2 block">{t("Our Expertise")}</span>
              ...
              <div className="space-y-16 lg:space-y-24">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">01</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Brick & Block Work")}</h3>
                    </div>
                    <ul className="space-y-4">
                      {[t("Brick Wall Construction"), t("Block Wall Installation"), t("Boundary Wall Construction"), t("Partition Wall Installation"), t("Wall Extensions")].map((item, idx) => (
                        <li key={idx} className="flex gap-4 items-start bg-slate-50 p-4 rounded-xl border border-slate-100 transition-colors hover:border-[var(--primary)]/30">
                          <CheckCircle2 size={22} className="text-[var(--primary)] shrink-0 mt-0.5" />
                          <span className="text-slate-700 font-medium">{item}</span>
                        </li>
                  ...
                  <div className="w-full lg:w-1/2 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/masonry_brickwork.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Brick & Block Work")} />
                  </div>
                </AnimatedCard>
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 order-2 lg:order-1 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/masonry_plastering.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Plastering Services")} />
                  </div>
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">02</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Plastering Services")}</h3>
                    </div>
                    <ul className="space-y-4">
                      {[t("Internal Wall Plastering"), t("External Wall Plastering"), t("Ceiling Plaster Repair"), t("Crack Filling & Wall Repair"), t("Surface Leveling")].map((item, idx) => (
                        <li key={idx} className="flex gap-4 items-start bg-slate-50 p-4 rounded-xl border border-slate-100 transition-colors hover:border-[var(--primary)]/30">
                          <CheckCircle2 size={22} className="text-[var(--primary)] shrink-0 mt-0.5" />
                          <span className="text-slate-700 font-medium">{item}</span>
                        </li>
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">03</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Tile Install & Repair")}</h3>
                    </div>
                    <ul className="space-y-4">
                      {[t("Floor Tile Installation"), t("Wall Tile Installation"), t("Tile Replacement"), t("Bathroom Tile Install"), t("Kitchen Tile Install"), t("Tile Grouting & Finishing")].map((item, idx) => (
                        <li key={idx} className="flex gap-4 items-start bg-slate-50 p-4 rounded-xl border border-slate-100 transition-colors hover:border-[var(--primary)]/30">
                          <CheckCircle2 size={22} className="text-[var(--primary)] shrink-0 mt-0.5" />
                          <span className="text-slate-700 font-medium">{item}</span>
                        </li>
                  ...
                  <div className="w-full lg:w-1/2 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/masonry_tiling.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Tile Install & Repair")} />
                  </div>
                </AnimatedCard>
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 order-2 lg:order-1 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/masonry_concrete.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Concrete Works")} />
                  </div>
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">04</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Concrete Works")}</h3>
                    </div>
                    <ul className="space-y-4">
                      {[t("Concrete Repair"), t("Floor Screeding"), t("Concrete Slab Repair"), t("Cement Construction"), t("Minor Civil Repairs")].map((item, idx) => (
                        <li key={idx} className="flex gap-4 items-start bg-slate-50 p-4 rounded-xl border border-slate-100 transition-colors hover:border-[var(--primary)]/30">
                          <CheckCircle2 size={22} className="text-[var(--primary)] shrink-0 mt-0.5" />
                          <span className="text-slate-700 font-medium">{item}</span>
                        </li>
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">05</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Renovation Services")}</h3>
                    </div>
                    <ul className="space-y-4">
                      {[t("Bathroom Renovation"), t("Kitchen Renovation"), t("Wall Alterations"), t("Door & Window Adjustments"), t("Structural Repair (Non-Major)")].map((item, idx) => (
                        <li key={idx} className="flex gap-4 items-start bg-slate-50 p-4 rounded-xl border border-slate-100 transition-colors hover:border-[var(--primary)]/30">
                          <CheckCircle2 size={22} className="text-[var(--primary)] shrink-0 mt-0.5" />
                          <span className="text-slate-700 font-medium">{item}</span>
                        </li>
                  ...
                  <div className="w-full lg:w-1/2 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/masonry_renovations.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Renovation Services")} />
                  </div>
                </AnimatedCard>
          ...
          <section id="process" className="py-20 bg-gradient-to-b from-[#fefaef] to-[#e2f2f1]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:pr-8 lg:pl-28">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-5 xl:col-span-4">
                  <div className="relative aspect-[4/5] rounded-3xl overflow-hidden group">
                    <Image src={t("/images/services/masonry_workflow.png")} fill sizes="(max-width: 1024px) 100vw, 33vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Service Workflow")} />
                  </div>
                </div>
              </div>
            </div>
    ...
    return (
      <>
        ...
        <main className="bg-white">
          ...
          {/* Section 3: Our Carpentry Services (Premium Alternating Layout) */}
          <section id="services" className="py-24 bg-gradient-to-b from-[#cdeae8] to-[#e2f2f1] relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:pr-8 lg:pl-28">
              <div className="text-center max-w-3xl mx-auto mb-16">
                <span className="text-[var(--primary)] font-semibold tracking-wider uppercase text-sm mb-2 block">{t("Our Expertise")}</span>
              ...
              <div className="space-y-16 lg:space-y-24">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">01</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Custom Furniture & Fit-Out")}</h3>
                    </div>
                    <ul className="space-y-4">
                      {[t("Custom Wardrobes"), t("TV Wall Units & Stands"), t("Study Tables & Desks"), t("Storage Cabinets"), t("Shoe Cabinets & Shelving"), t("Bookshelves & Display Units")].map((item, idx) => (
                        <li key={idx} className="flex gap-4 items-start bg-slate-50 p-4 rounded-xl border border-slate-100 transition-colors hover:border-[var(--primary)]/30">
                          <CheckCircle2 size={22} className="text-[var(--primary)] shrink-0 mt-0.5" />
                          <span className="text-slate-700 font-medium">{item}</span>
                        </li>
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  ...
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">02</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Kitchen Carpentry")}</h3>
                    </div>
                    <ul className="space-y-4">
                      {[t("Cabinet Installation"), t("Custom Kitchen Cabinets"), t("Smart Storage Solutions"), t("Cabinet Door Replacement"), t("Cabinet Repairs & Hinges")].map((item, idx) => (
                        <li key={idx} className="flex gap-4 items-start bg-slate-50 p-4 rounded-xl border border-slate-100 transition-colors hover:border-[var(--primary)]/30">
                          <CheckCircle2 size={22} className="text-[var(--primary)] shrink-0 mt-0.5" />
                          <span className="text-slate-700 font-medium">{item}</span>
                        </li>
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">03</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Doors, Partitions & Panels")}</h3>
                    </div>
                    <ul className="space-y-4">
                      {[t("Wooden Door Installation"), t("Door Frame Fitting"), t("Sliding Door Installation"), t("Wooden Partitions"), t("Wall Paneling & Cladding"), t("Decorative Wood Panels")].map((item, idx) => (
                        <li key={idx} className="flex gap-4 items-start bg-slate-50 p-4 rounded-xl border border-slate-100 transition-colors hover:border-[var(--primary)]/30">
                          <CheckCircle2 size={22} className="text-[var(--primary)] shrink-0 mt-0.5" />
                          <span className="text-slate-700 font-medium">{item}</span>
                        </li>
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  ...
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">04</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Flooring & Furniture Repairs")}</h3>
                    </div>
                    <ul className="space-y-4">
                      {[t("Wooden Flooring Install"), t("Laminate & Vinyl Flooring"), t("Skirting Installation"), t("Wardrobe & Drawer Repair"), t("Door Realignment"), t("Hinge & Handle Replacement")].map((item, idx) => (
                        <li key={idx} className="flex gap-4 items-start bg-slate-50 p-4 rounded-xl border border-slate-100 transition-colors hover:border-[var(--primary)]/30">
                          <CheckCircle2 size={22} className="text-[var(--primary)] shrink-0 mt-0.5" />
                          <span className="text-slate-700 font-medium">{item}</span>
                        </li>
              ...
              <div className="space-y-16 lg:space-y-24">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">01</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Reinforcement Steel")}</h3>
                    </div>
                    <ul className="space-y-4">
                  ...
                  <div className="w-full lg:w-1/2 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/steel_reinforcement.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Reinforcement Steel")} />
                  </div>
                </AnimatedCard>
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 order-2 lg:order-1 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/steel_structural.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Structural Steel")} />
                  </div>
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">02</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Structural Steel")}</h3>
                    </div>
                    <ul className="space-y-4">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">03</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Steel Fabrication")}</h3>
                    </div>
                    <ul className="space-y-4">
                  ...
                  <div className="w-full lg:w-1/2 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/steel_fabrication.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Steel Fabrication")} />
                  </div>
                </AnimatedCard>
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 order-2 lg:order-1 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/steel_civil.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Civil Support Services")} />
                  </div>
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">04</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Civil Support Services")}</h3>
                    </div>
                    <ul className="space-y-4">
          ...
          <section id="process" className="py-20 bg-gradient-to-b from-[#fefaef] to-[#e2f2f1]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:pr-8 lg:pl-28">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-5 xl:col-span-4">
                  <div className="relative aspect-[4/5] rounded-3xl overflow-hidden group">
                    <Image src={t("/images/services/steel_workflow.png")} fill sizes="(max-width: 1024px) 100vw, 33vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Service Workflow")} />
                  </div>
                </div>
              </div>
            </div>
    ...
    return (
      <>
        ...
        <main className="bg-white">
          ...
          {/* Section 3: Our Interior Designing Services (Premium Alternating Layout) */}
          <section id="services" className="py-24 bg-gradient-to-b from-[#cdeae8] to-[#e2f2f1] relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:pr-8 lg:pl-28">
              <div className="text-center max-w-3xl mx-auto mb-16">
                <span className="text-[var(--primary)] font-semibold tracking-wider uppercase text-sm mb-2 block">{t("Our Expertise")}</span>
              ...
              <div className="space-y-16 lg:space-y-24">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">01</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Residential Design")}</h3>
                    </div>
                    <ul className="space-y-4">
                      {[t("Apartment Interior Design"), t("Villa Interior Design"), t("Bedroom Design & Layouts"), t("Living Room Makeovers"), t("Dining Area Styling"), t("Balcony Landscaping")].map((item, idx) => (
                        <li key={idx} className="flex gap-4 items-start bg-slate-50 p-4 rounded-xl border border-slate-100 transition-colors hover:border-[var(--primary)]/30">
                          <CheckCircle2 size={22} className="text-[var(--primary)] shrink-0 mt-0.5" />
                          <span className="text-slate-700 font-medium">{item}</span>
                        </li>
                  ...
                  <div className="w-full lg:w-1/2 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/interior_residential.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Residential Design")} />
                  </div>
                </AnimatedCard>
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 order-2 lg:order-1 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/interior_commercial.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Commercial Design")} />
                  </div>
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">02</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Commercial Design")}</h3>
                    </div>
                    <ul className="space-y-4">
                      {[t("Office Interior Layouts"), t("Retail Shop Design"), t("Restaurant & Café Styling"), t("Salon & Spa Interior Design"), t("Clinic Interior Setups"), t("Hotel & Showroom Designs")].map((item, idx) => (
                        <li key={idx} className="flex gap-4 items-start bg-slate-50 p-4 rounded-xl border border-slate-100 transition-colors hover:border-[var(--primary)]/30">
                          <CheckCircle2 size={22} className="text-[var(--primary)] shrink-0 mt-0.5" />
                          <span className="text-slate-700 font-medium">{item}</span>
                        </li>
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">03</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Space & Fit-Out")}</h3>
                    </div>
                    <ul className="space-y-4">
                      {[t("Space Layout Planning"), t("Complete Interior Renovation"), t("Office Fit-Out Execution"), t("Home Remodeling Solutions"), t("Partition Wall Design"), t("Ceiling Layouts")].map((item, idx) => (
                        <li key={idx} className="flex gap-4 items-start bg-slate-50 p-4 rounded-xl border border-slate-100 transition-colors hover:border-[var(--primary)]/30">
                          <CheckCircle2 size={22} className="text-[var(--primary)] shrink-0 mt-0.5" />
                          <span className="text-slate-700 font-medium">{item}</span>
                        </li>
                  ...
                  <div className="w-full lg:w-1/2 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/interior_fitout.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Space & Fit-Out")} />
                  </div>
                </AnimatedCard>
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 order-2 lg:order-1 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/interior_decorative.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Decorative Solutions")} />
                  </div>
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">04</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Decorative Solutions")}</h3>
                    </div>
                    <ul className="space-y-4">
                      {[t("Gypsum False Ceilings"), t("Feature Wall Construction"), t("Decorative Wall Panels"), t("Architectural Lighting"), t("Wallpaper Installation"), t("Wooden Wall Cladding")].map((item, idx) => (
                        <li key={idx} className="flex gap-4 items-start bg-slate-50 p-4 rounded-xl border border-slate-100 transition-colors hover:border-[var(--primary)]/30">
                          <CheckCircle2 size={22} className="text-[var(--primary)] shrink-0 mt-0.5" />
                          <span className="text-slate-700 font-medium">{item}</span>
                        </li>
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">05</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Custom Furniture")}</h3>
                    </div>
                    <ul className="space-y-4">
                      {[t("Custom Furniture Crafting"), t("Sleek TV Units"), t("Modular Wardrobes"), t("Kitchen Cabinets"), t("Office Workstations"), t("Smart Storage Solutions")].map((item, idx) => (
                        <li key={idx} className="flex gap-4 items-start bg-slate-50 p-4 rounded-xl border border-slate-100 transition-colors hover:border-[var(--primary)]/30">
                          <CheckCircle2 size={22} className="text-[var(--primary)] shrink-0 mt-0.5" />
                          <span className="text-slate-700 font-medium">{item}</span>
                        </li>
                  ...
                  <div className="w-full lg:w-1/2 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/interior_furniture.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Custom Furniture")} />
                  </div>
                </AnimatedCard>
          ...
          <section id="process" className="py-20 bg-gradient-to-b from-[#fefaef] to-[#e2f2f1]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:pr-8 lg:pl-28">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-5 xl:col-span-4">
                  <div className="relative aspect-[4/5] rounded-3xl overflow-hidden group">
                    <Image src={t("/images/services/interior_workflow.png")} fill sizes="(max-width: 1024px) 100vw, 33vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Service Workflow")} />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-16 lg:space-y-24">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">01</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Ceiling Installation")}</h3>
                    </div>
                    <ul className="space-y-4">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  ...
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">02</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Partition Services")}</h3>
                    </div>
                    <ul className="space-y-4">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">03</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Interior Finishing")}</h3>
                    </div>
                    <ul className="space-y-4">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  ...
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">04</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Repair & Maintenance")}</h3>
                    </div>
                    <ul className="space-y-4">
              ...
              <div className="space-y-16 lg:space-y-24">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">01</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Mounting & Installation")}</h3>
                    </div>
                    <ul className="space-y-4">
                  ...
                  <div className="w-full lg:w-1/2 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/handyman_mounting.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Mounting & Installation")} />
                  </div>
                </AnimatedCard>
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 order-2 lg:order-1 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/handyman_assembly.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Furniture Assembly")} />
                  </div>
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">02</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Furniture Assembly")}</h3>
                    </div>
                    <ul className="space-y-4">
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">03</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Home & Carpentry Repairs")}</h3>
                    </div>
                    <ul className="space-y-4">
                  ...
                  <div className="w-full lg:w-1/2 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/handyman_repairs.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Home & Carpentry Repairs")} />
                  </div>
                </AnimatedCard>
                ...
                <AnimatedCard delay={0.1} className="flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_60px_-15px_rgba(32,80,124,0.2)] transition-all duration-500 hover:-translate-y-3 relative overflow-hidden border border-slate-100/50 group">
                  <div className="w-full lg:w-1/2 order-2 lg:order-1 relative min-h-[350px] lg:min-h-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-white to-transparent lg:block hidden z-10 w-24" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent lg:hidden block z-10 h-24" />
                      <Image src={t("/images/services/handyman_installations.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Electrical & Plumbing")} />
                  </div>
                  <div className="w-full lg:w-1/2 order-1 lg:order-2 p-10 lg:p-16 space-y-6 flex flex-col justify-center relative z-10 bg-white">
                    <div className="inline-flex items-center gap-4 mb-2">
                      <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-[var(--primary)] font-black text-2xl flex items-center justify-center shadow-inner border border-blue-200/50 transform group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">04</div>
                      <h3 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] bg-clip-text text-transparent bg-gradient-to-r from-[var(--dark)] to-[var(--primary)]">{t("Electrical & Plumbing")}</h3>
                    </div>
                    <ul className="space-y-4">
          ...
          <section id="process" className="py-20 bg-gradient-to-b from-[#fefaef] to-[#e2f2f1]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:pr-8 lg:pl-28">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-5 xl:col-span-4">
                  <div className="relative aspect-[4/5] rounded-3xl overflow-hidden group">
                    <Image src={t("/images/services/handyman_workflow.png")} fill sizes="(max-width: 1024px) 100vw, 33vw" className="object-cover transition-transform duration-700 group-hover:scale-105" alt={t("Service Workflow")} />
                  </div>
                </div>
              </div>
            </div>
  ...
  return (
    <>
      ...
      <main>
        ...
        <section id="overview" className="py-20 bg-gradient-to-b from-[#cdeae8] via-[#fefaef] to-[#cdeae8]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:pr-8 lg:pl-28">
